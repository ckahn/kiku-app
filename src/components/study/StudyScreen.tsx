            ...
            <ul className="space-y-3">
              {studyGuide.vocabulary.map((item) => (
                <li key={item.id} className="space-y-1">
                  ...
                  {hasDistinctReading(item.reading, item.japanese) && <p className="text-sm text-muted">{item.reading}</p>}
            ...
            <ul className="space-y-3">
              {studyGuide.structures.map((item) => (
                <li key={item.id} className="space-y-1">
                  ...
                  {hasDistinctReading(item.reading, item.pattern) && <p className="text-sm text-muted">{item.reading}</p>}
                  <p className="text-sm text-ink">{item.meaning}</p>
